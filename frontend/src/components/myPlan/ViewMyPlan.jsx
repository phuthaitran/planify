      ...
      try {
        ...
        const mockPlans = {
          ...
          "my-progress-1": {
            ...
            description:
              "Master advanced React concepts including hooks, context, performance optimization, and state management with Redux Toolkit.",
            imageUrl: null,
                ...
                tasks: [
                  {
                    ...
                    duration: "7",
                    subtasks: ["useEffect for side effects", "useState for local state", "Memoization techniques"],
                  },
                ],
              },
              {
                ...
                tasks: [
                  {
                    title: "Context API",
                    description: "Implement global state with Context.",
                    duration: "7",
                    subtasks: ["Create providers", "Consume context", "Optimization"],
                  },
                ],
              },
            ],
          ...
          "my-recent-1": {
            ...
            description:
              "Build a sustainable morning habit with bodyweight exercises. No gym required!",
            imageUrl: null,
            categories: ["Fitness", "Health", "Exercise"],
            stages: [
              {
                title: "Week 1: Basics",
                ...
                tasks: [
                  {
                    ...
                    duration: "7",
                    subtasks: ["10 min jog in place", "3 sets of push-ups", "Stretch"],
                  },
                ],
              },
              {
                title: "Week 2: Core Focus",
                description: "Strengthen your core muscles.",
                tasks: [
                  {
                    title: "Plank Circuit",
                    description: "Daily plank variations.",
                    duration: "7",
                    subtasks: ["Standard plank", "Side plank", "Plank jacks"],
                  },
                ],
              },
            ],
          ...
          "my-all-1": {
            ...
            description:
              "Plan nutritious meals for better health and energy.",
            imageUrl: null,
            categories: ["Nutrition", "Health", "Diet"],
            stages: [
              {
                ...
                tasks: [
                  {
                    ...
                    duration: "7",
                    subtasks: ["Choose veggies", "Select proteins", "Avoid processed foods"],
                  },
                ],
              },
              {
                title: "Week 2: Recipe Trials",
                description: "Try simple healthy recipes.",
                tasks: [
                  {
                    title: "Daily Meal Prep",
                    description: "Prepare meals in advance.",
                    duration: "7",
                    subtasks: ["Breakfast smoothies", "Lunch salads", "Dinner stir-frys"],
                  },
                ],
              },
            ],
  ...
  if (isEditing) {
    return (
      <>
        ...
        />
        {showPreview && (
          <PreviewModal planData={plan} onClose={() => setShowPreview(false)} />
        )}
      </>
    );
  }
